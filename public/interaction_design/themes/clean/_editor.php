...
?></h1>
    ...
    ?>
    <div id="content">
        <div id="panel_1" class="<?php print $layout; ?>"><div class="panel_inner"><?php print $this->content1; ?></div></div>
        <div id="panel_2" class="<?php print $layout; ?>"><div class="panel_inner"><?php print $this->content2; ?></div></div>
        <div id="panel_3" class="<?php print $layout; ?>"><div class="panel_inner"><?php print $this->content3; ?></div></div>
        <div id="panel_4" class="<?php print $layout; ?>"><div class="panel_inner"><?php print $this->content4; ?></div></div>
        <div id="resizehandle_1" class="<?php print $layout; ?>"></div>
        <div id="resizehandle_2" class="<?php print $layout; ?>"></div>
        <div id="resizehandle_3" class="<?php print $layout; ?>"></div>
    </div>
