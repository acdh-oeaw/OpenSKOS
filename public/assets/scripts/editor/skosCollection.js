...
var EditorSkosCollection = new Class({
	...
	initialize: function () {
		...
		$(document.body).addEvent('click:relay(#skosCollectionSave)', function (e) {
			e.stop();
			Editor.Control.saveSkosCollection();
		});
	},
	initSkosCollectionForm: function () {
