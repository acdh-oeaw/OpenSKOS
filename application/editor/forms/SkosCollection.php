...
class Editor_Forms_SkosCollection extends OpenSKOS_Form
{
	/**
	...
	{
		$this->setName('Edit skos collection');
		$this->setMethod('Post');
	...
	protected function buildHeader()
	{
		...
		$this->addElement('submit', 'skosCollectionSave', array(
				'label' => _('Ok'),
		...
		$this->addDisplayGroup(
				array('collection', 'uriBase', 'uriCode', 'skosCollectionSave'),
				'concept-header',
				array('legend' => 'header',
	...
	public static function getInstance($isCreate = false)
	{
		...
		if (null === $instance) {
			$instance = new Editor_Forms_SkosCollection(array('isCreate' => $isCreate));
		}
